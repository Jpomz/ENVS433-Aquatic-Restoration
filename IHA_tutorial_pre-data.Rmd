...
$$ \%D =  \frac{\text{DM}} {\text{pre}} $$

Where $\%D$ is the per cent deviation, $DM$ is the deviation magnitude, and $pre$ is the value for a given metric calculated before dam closure.  
